...
const SmallHeader = () => {
	return (
		<div className="flex justify-between items-center bg-white h-9 px-20 border-b border-gray-300 w-full">
			<span className="flex items-center space-x-1 hover:cursor-pointer">
			...
			{/*shipping info*/}
			<span className="text-sm font-normal text-gray-700">Free Shipping on Orders Ksh. 50,000+</span>
		</div>
	)
}
