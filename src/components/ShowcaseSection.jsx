		...
		<div className="grid grid-cols-12 h-[450px] w-full px-20 my-8 gap-x-6">
			...
			<div className="flex col-span-3 flex-col justify-between items-center">
				<div className="flex justify-between space-x-3 items-center bg-gray-100 rounded-sm p-6">
					<img className="h-20 w-20 " src="https://electrox.arenacommerce.com/cdn/shop/files/slider-img-h4-1.png?v=1650005832&width=338" alt="" />
					<span className="">
						<p className="">CATCH BIG DEALS ON THE CAMERAS</p>
					</span>
				</div>
				<div className="flex justify-between space-x-3 items-center bg-gray-100 rounded-sm p-6">
					<img className="h-20 w-20 " src="https://electrox.arenacommerce.com/cdn/shop/files/image-right-h4-2.png?v=1651141955&width=100" alt="" />
					<span className="">
						<p className="">CATCH BIG DEALS ON THE CAMERAS</p>
					</span>
				</div>
				<div className="flex justify-between space-x-3 items-center bg-gray-100 rounded-sm p-6">
					<img className="h-20 w-20 " src="https://electrox.arenacommerce.com/cdn/shop/files/image-right-h4-3.png?v=1651141968&width=100" alt="" />
					<span className="">
						<p className="">CATCH BIG DEALS ON THE CAMERAS</p>
					</span>
				</div>
