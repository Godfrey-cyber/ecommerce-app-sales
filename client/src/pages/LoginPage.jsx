...
//   return (
//     <div className="grid grid-cols-12 gap-8 w-full h-96 md:h-[500px] overflow-hidden px-5 md:px-10 lg:px-20">
//       {/* Slides */}
//     	<div className="col-span-9 flex flex-col relative w-full">
