...
const ShowcaseSection = () => {
	return (
		<div className="grid grid-cols-12 h-[450px] w-full px-5 md:px-10 lg:px-20 my-8 gap-x-6">
			<div className="col-span-12 lg:col-span-9 flex justify-between items-center bg-gray-100 px-5 md:px-10 lg:px-20 w-full h-full">
				{/*desc*/}
			...
			<div className="hidden md:flex col-span-3 flex-col justify-between items-center">
