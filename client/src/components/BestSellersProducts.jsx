		...
		<div className="w-full my-12 px-4 md:px-8">
	      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-8 divide-x">
				{data?.products?.map(product => (
					...
					<div className="relative w-44 md:w-52 lg:w-64 bg-white rounded-sm shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
