			...
			<div className="flex justify-between items-center h-full">
				...
				<div className="hidden lg:flex items-center">
					<span className="border-0 bg-white w-[400px] h-10 rounded-tl-3xl rounded-bl-3xl">
						<input placeholder="Search for products online, Electronics, Gloceries, Computing...." className="placeholder:text-xs bg-transparent text-gray-700 w-full focus:outline-none px-6 text-sm font-light h-full" type="text" name="" id="" />
					</span>
