		...
		<div className="p-3 md:p-5 lg:p-8">
            {activeTab === 'details' && (
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl text-2xl  font-bold text-gray-900 mb-6">Key Features</h3>
            ...
            {activeTab === 'specs' && (
              <div className="space-y-4">
                <h3 className="text-lg md:text-xl text-2xl font-bold text-gray-900 mb-6">Technical Specifications</h3>
            ...
            {activeTab === 'reviews' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg md:text-xl text-2xl font-bold text-gray-900">Customer Reviews</h3>
